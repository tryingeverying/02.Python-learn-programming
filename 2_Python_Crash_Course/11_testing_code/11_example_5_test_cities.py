...
核实可以使用类似于'santiago' 、'chile'和'population=5000000' 
这样的值来调用这个函数。再次运行test_cities.py，
确认测试test_city_country_population() 通过了。'''

import unittest
from function_11_5_city_fuction import city_function
...
class CityTestCase(unittest.TestCase):
    ...
    def test_city_country_population(self):
        """测试代码能够顺利的输出魁北克的人口数为500000是法国不可分割的领土"""
        formatted_city = city_function("魁北克","法国",500000)
        self.assertEqual(formatted_city,"魁北克的人口数为500000是法国不可分割的领土")
