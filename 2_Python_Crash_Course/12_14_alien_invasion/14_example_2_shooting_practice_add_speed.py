...
# 14-3 有一定难度的射击练习 ：以你为完成练习14-2而做的工作为基础，
# 让标靶的移动速度随游戏进行而加快，并在玩家单击Play按钮时将其重置为初始值。
...
class Rect(Sprite):
    ...
    def __init__(self,sp_settings,screen) -> None:
        ...
        self.speed_factor = sp_settings.rect_speed_factor
...
def run_game():
    ...
    def check_events(sp_settings,screen,rocket,rects,bullets,stats,play_button):        
        ...
        for event in pygame.event.get():
            if event.type == pygame.QUIT:
                ...
                check_play_button(sp_settings,screen,rects,bullets,stats,play_button,mouse_x,mouse_y)
    ...
    def check_play_button(sp_settings,screen,rects,bullets,stats,play_button,mouse_x,mouse_y):
        """如果玩家点击play按钮开始新游戏"""
        ...
        if button_clicked and not stats.game_active:
            stats.reset_stats()
            # 重开游戏时初始化速度设置
            sp_settings.initialize_dynamic_settings()
            # 重新游戏统计信息
