...
def write_to_file(content):
    with open(r'test_project\res\txt\maoyan_result.txt','+a',encoding='utf-8') as f:
        f.write(content + '\n')

def main():
    for num_i in range(0,100,10):
        new_url = 'https://www.maoyan.com/board/4?offset=' + str(num_i)
