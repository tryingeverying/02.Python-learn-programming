...
def write_to_file(content):
    with open(r'test_project\res\txt\douban_result.txt', 'a', encoding='utf-8', ) as f:
        f.write(content + '\n')

def main():
    for num_i in range(0,100,25):
        url = 'https://movie.douban.com/top250?start='+str(num_i)+'&filter='
